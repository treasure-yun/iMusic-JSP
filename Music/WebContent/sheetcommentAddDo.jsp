...
<%
    ...
    String content = request.getParameter("sheetComment");
	Date date=new Date(System.currentTimeMillis());
    try {
        String str = "insert into SheetComment values('"+Integer.valueOf(userid)+"','"+Integer.valueOf(sheetid)+"','"+content+"','"+date.toString()+"')";
